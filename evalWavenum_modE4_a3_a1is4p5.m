...
plot(ks_vec,real(RLam6_2(:,4)),'bd-');


 xlabel('k^2','FontSize',14); ylabel('Re(\lambda)','FontSize',14);
hh= legend('\alpha_{3}=3.5','\alpha_{3}=3.2','\alpha_{3}=2.5', 'Location','NorthEast')
legend('boxoff')
%set(hh,'Visible', 'Off')

set(gca,'FontSize',14) 

plot(ks_vec,zeros(1,numpts),'r--');
...
saveas(gcf, 'evals_model_E4_a3_a1is4p5', 'pdf')
